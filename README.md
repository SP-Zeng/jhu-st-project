...
**Tests**
  ...
  3. RestAssured for API Testing on the Backend in `\GUItesting\src\test\java`. Use Intellj, open the test file end with ".java" then press "ctrl + shift + F10" or press "Run" to go over tests. (It's a Gradle Project, in Intellij, import project folder as \GUItesting)
  4. Selenium GUI Testing on the Backend in `\ApiTesting\src\test\java`. Use Intellj, open the test file end with ".java" then press "ctrl + shift + F10" or press "Run" to go over tests. (It's a Gradle Project, in Intellij, import project folder as \ApiTesting)
